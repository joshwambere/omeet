import LoginWrapper from '../Auth/wrapper/AuthWrapper';
...
import {
    setCredentials,
    setUserInfo
} from '@/_shared/redux/slices/auth.slice';
            ...
            >
              ...
              Forgot Password
                    ...
                    <div className="pt-4">
                        ...
                        <span
                            className="text-[#3791f3] ml-2 font-bold hover:cursor-pointer hover:underline"
              ...
              Sign up
                ...
                <div className=" flex pt-3 w-full px-3 items-center justify-center bg-[#3791f3] self-end bottom-section ">
